    ...
    <div class="dropdown-wrapper">
        <select class="cv-dropdown" onchange="if (this.value) window.location.href = this.value;">
            ...
            <option value="create_cv.php">Create New CV</option>
                ...
                <li class="lists"><a class="options" href="contact.php">Contact</a></li>
                <li class="lists" id="log_list">
                    <?php if (isset($_SESSION['username'])): ?>
                        <a id="log_option" href="logout.php" class="btn options">Log out</a>
                    <?php else: ?>
                        <a id="log_option" href="logout.php" class="btn options">Login</a>
                    <?php endif; ?>
                </li>
            </ul>
